...
#### Podcast
Outside of coding, I also host two podcastshttps://soundcloud.com/listeningcircle/, [one of which](https://www.youtube.com/channel/UCtM9VzujJ4bK-82xIi0vKFQ) is about music (surprise surprise), and [the other](https://medium.com/solutions) is about finding solutions to societal problems. I store the episode metadata in a [JSON file](https://github.com/FOSSforlife/podcast-site/blob/master/src/assets/data/episodes.json) and have a script that generates the podcast RSS from it and deploys it to Netlify. The episodes are hosted on DigitalOcean Spaces.
